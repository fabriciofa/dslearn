...
public class DSLearnExceptionHandler {
	...
	public ResponseEntity<OAuthCustomError> unauthozired(UnauthorizedException e, HttpServletRequest request) {
		OAuthCustomError err = new OAuthCustomError("Unauthozired", e.getMessage());
